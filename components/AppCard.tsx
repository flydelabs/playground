...
export function AppCard({ app }: { app: PlaygroundApp }) {
  ...
  return (
    <div
      className="flex flex-col justify-between w-96 h-36 py-5 px-10 border-slate-200 border bg-white rounded-xl shadow-lg m-4 hover:bg-gray-100 cursor-pointer"
