...
declare module '@flyde/core' {
    ...
    import { CustomNode, VisualNode, InputPinsConfig, Node, NodeDefinition } from "@flyde/core/node";
    ...
    export * from "@flyde/core/inline-value-to-code-node";
    export * from "@flyde/core/web-project";
...
declare module '@flyde/core/connect' {
    ...
    import { Debugger, ExecuteEnv } from "@flyde/core/execute";
    ...
    export const connect: (node: PositionlessVisualNode, resolvedDeps: NodesCollection, _debugger?: Debugger, ancestorsInsIds?: string, mainState?: OMap<NodeState>, onBubbleError?: (err: any) => void, env?: ExecuteEnv, extraContext?: Record<string, any>) => CodeNode;
}
...
declare module '@flyde/core/inline-value-to-code-node' {
    import { CodeNode, InlineValueNode, NodesCollection } from "@flyde/core/node";
    export const inlineValueNodeToNode: (inlineValueNode: InlineValueNode, extraContext?: Record<string, any>) => CodeNode;
    export const customNodesToNodesCollection: (customNodes: NodesCollection, extraContext?: Record<string, any>) => NodesCollection;
}

declare module '@flyde/core/web-project' {
...
declare module '@flyde/core/flow-schema' {
    import { z } from "zod";
    import { VisualNode, NodeDefinition, Node } from "@flyde/core/node";
    ...
    export const flydeFlowSchema: z.ZodObject<{
        ...
        node: z.ZodIntersection<z.ZodObject<{
            instances: z.ZodArray<z.ZodEffects<z.ZodObject<{
            ...
            customViewCode: z.ZodOptional<z.ZodString>;
            dataBuilderSource: z.ZodOptional<z.ZodString>;
...
declare module '@flyde/core/node/node-instance' {
    import { InputPinsConfig, Node, NodeDefinition, NodeStyle, Pos } from "@flyde/core/";
    ...
    export const inlineNodeInstance: (id: string, node: Node, config?: InputPinsConfig, pos?: Pos) => NodeInstance;
...
declare module '@flyde/core/node/node-pins' {
    ...
    import { QueueInputPinConfig, StaticInputPinConfig, StickyInputPinConfig } from "@flyde/core/node/pin-config";
    ...
    export const isDynamicInput: (arg: NodeInput | undefined) => arg is DynamicNodeInput;
    export const isStaticInput: (arg: NodeInput | undefined) => arg is StaticNodeInput;
    export const extractStaticValue: (arg: NodeInput) => any;
    export const isEnvValue: (value: any) => boolean;
    export const toEnvValue: (name: any) => string;
    export const getEnvKeyFromValue: (value: string) => string;
}
...
declare module '@flyde/core/node/pin-config' {
    ...
    export type InputPinConfig = QueueInputPinConfig | StickyInputPinConfig | StaticInputPinConfig;
    ...
    export function isStaticInputPinConfig(config: InputPinConfig | undefined): config is StaticInputPinConfig;
}
...
declare module '@flyde/core/node/node' {
    ...
    export const isInlineValueNode: (p: Node | NodeDefinition | undefined) => p is InlineValueNode;
    ...
    export const inlineValueNode: import("../common").TestDataCreator<InlineValueNode>;
    ...
    export const maybeGetStaticValueNodeId: (value: string) => string;
    export const getStaticValue: (value: any, resolvedDeps: NodesDefCollection, calleeId: string) => any;
